...
% parseBiologicMPR.m - A MATLAB script for parsing Biologic .mpr files that has ASCII "MODULE" markers.

%
% This file is inspired largely on the YADG project:  
% https://github.com/dgbowl/yadg  
%
% Licensed under the GNU General Public License v3 (GPLv3).  
% You may redistribute and modify it under the terms of GPLv3.
%
